...
1. 📦 Urban Freight & Last-Mile Logistics Optimization
...
1. 🌐 3D Urban Form and Shadow Analysis
...
1. 🧹 Informal Settlement Detection and Monitoring
...
1. 🚍 Public Transit Reliability and Rider Experience
...
1. 🌳 Urban Tree Canopy and Heat Island Mitigation
...
1. 🧭 Wayfinding and Spatial Legibility
...
1. 📉 Vacancy and Urban Shrinkage Modeling
...
1. 🏥 Disaster Resilience of Urban Infrastructure
...
1.  🧑‍🔬 Behavioral Simulation of Public Space Usage
...
1.  🚶‍♂️ Walkability Index Mapping and Improvement
...
1.  🏙️ Spatiotemporal Patterns of Vertical Growth
...
1.  🪧 Commercial Land Use Fragmentation
...
1.  🧵 Urban Patchwork Analysis (Land Use Mosaic)
...
1.  🚌 Transit-Oriented Development (TOD) Potential Scoring
...
1.  🧑‍⚖️ Zoning Code Compliance Checker
...
1.  🧠 Perceived Safety and Urban Form (Computer Vision + GIS)
...
1.  🎓 Campus Urbanism and Spatial Performance of Universities
...
1.  🚲 Cycling Infrastructure Equity Analysis
...
1.  🧬 Urban Fabric Classification with Unsupervised Learning
...
1.  🌍 Urban Carbon Footprint Mapping
